  ...
  <div class="container">
    ...
    <div class="mainpage5">
      ...
      <form class="contactform" action="contactpagina.php" method="POST"><br>
        <label for="naam">
          <h3>Naam:</h3>
        </label><br><input type="text" name="naam" placeholder="Uw naam!" required><br>
        <label for="email">
          <h3>Email:</h3>
        </label><br><input type="text" name="email" placeholder="Uw E-mail!" required><br>
        <label for="titel">
          <h3>Titel:</h3>
        </label><br><input type="text" name="titel" placeholder="Uw titel!" required><br>
        <label for="bericht">
          <h3>Bericht:</h3>
        </label><br><textarea name="bericht" placeholder="Zet hier uw bericht neer!" required></textarea><br>
